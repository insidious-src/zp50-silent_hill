...
new const zombieclass1_info[] = "Ordinary Monster"
new const zombieclass1_models[][] = { "sh_monster02" }
...
{
	register_plugin("[ZP] Class: Monster: Balanced", ZP_VERSION_STRING, "ZP Dev Team")

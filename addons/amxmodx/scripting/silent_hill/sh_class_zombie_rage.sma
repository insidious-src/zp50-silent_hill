...
new const zombieclass6_name[] = "Cultist Monster"
new const zombieclass6_info[] = "Can get to its prays very fast and explodes on death infecting every one around it"
new const zombieclass6_models[][] = { "zombie_source" }
new const zombieclass6_clawmodels[][] = { "models/zombie_plague/v_knife_zombie.mdl" }
const zombieclass6_health = 1300
